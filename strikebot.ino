...
void setup(void) {
  ...
  delay(1000);
  /*
  // MPU Initializiation and configuration
  if (!mpu.begin()) {
...
//   pitch = 180 * atan2(accelX, sqrt(accelY*accelY + accelZ*accelZ))/PI;
  ...
  */
  ...
  if(isDampingActive){
    ...
    servo1.write(kp*error+kd*error_d);
    servo2.write(kp*error+kd*error_d);
  }
  else{
